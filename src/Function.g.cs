...
namespace Grid2dExample
{
    public class Function
    {
        ...
        private IModelStore<Grid2dExampleInputs> store;

        public async Task<Grid2dExampleOutputs> Handler(Grid2dExampleInputs args, ILambdaContext context)
        {
            ...
            if(this.store == null)
            {
                this.store = new S3ModelStore<Grid2dExampleInputs>(RegionEndpoint.USWest1);
            }

            var l = new InvocationWrapper<Grid2dExampleInputs,Grid2dExampleOutputs>(store, Grid2dExample.Execute);
